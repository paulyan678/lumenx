...
import { api, type EnvConfigPayload, type MediaProviderMode, type ProviderMode, API_URL } from "@/lib/api";
  ...
  const renderApiKeys = () => (
    ...
    >
      {loading ? (
        ...
        <div className="space-y-1">
          <FormRow label={t("dashscopeKeyLabel")} hint="Optional when New API chat is configured below.">
          ...
          <FormRow
            label="OpenAI-compatible / New API"
            hint="Purpose-scoped credentials for chat, GPT Image, and Seedance. These keys are never sent to DashScope or MuleRouter."
          >
            <div className="space-y-4 rounded-lg border border-glass-border bg-surface p-4">
              <div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <FieldLabel>NEWAPI_CHAT_MODEL</FieldLabel>
                  <input
                ...
                <div>
                  <FieldLabel>NEWAPI_CHAT_API_KEY</FieldLabel>
                  <KeyField
                    value={config.NEWAPI_CHAT_API_KEY}
                    onChange={(v) => handleChange("NEWAPI_CHAT_API_KEY", v)}
                    placeholder="sk-..."
                  />
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <FieldLabel>NEWAPI_IMAGE_MODEL</FieldLabel>
                  <input
                ...
                <div>
                  <FieldLabel>NEWAPI_IMAGE_API_KEY</FieldLabel>
                  <KeyField
                    value={config.NEWAPI_IMAGE_API_KEY}
                    onChange={(v) => handleChange("NEWAPI_IMAGE_API_KEY", v)}
                    placeholder="sk-..."
                  />
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <FieldLabel>NEWAPI_VIDEO_MODEL</FieldLabel>
                  <input
                ...
                <div>
                  <FieldLabel>NEWAPI_VIDEO_API_KEY</FieldLabel>
                  <KeyField
                    value={config.NEWAPI_VIDEO_API_KEY}
                    onChange={(v) => handleChange("NEWAPI_VIDEO_API_KEY", v)}
                    placeholder="sk-..."
                  />
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <FieldLabel>GPT IMAGE ROUTE</FieldLabel>
                  <ModeSegment
                    value={config.GPT_IMAGE_PROVIDER_MODE}
                    onChange={(v) => handleChange("GPT_IMAGE_PROVIDER_MODE", v)}
                    options={[
                ...
                <div>
                  <FieldLabel>SEEDANCE ROUTE</FieldLabel>
                  <ModeSegment
