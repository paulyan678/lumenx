    ...
    const modal = (
        <>
            ...
            <div
                ...
                className="fixed left-1/2 top-1/2 z-[61] flex h-[80vh] w-[min(800px,92vw)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[12px] border border-foreground/10 bg-surface shadow-[0_24px_60px_-22px_rgba(0,0,0,0.9)] motion-safe:animate-[compareModalIn_240ms_cubic-bezier(0.22,1,0.36,1)_both]"
            >
                ...
                <footer className="flex shrink-0 items-center justify-between gap-3 border-t border-foreground/10 px-4 py-2.5 font-mono text-chrome-sm tracking-tight text-text-muted">
