                        ...
                        <div>
                            ...
                            {editing ? (
                                <textarea
                                    ...
                                    className="w-full h-32 rounded-lg border border-glass-border bg-elevated px-3 py-2.5 text-[12px] text-foreground leading-relaxed resize-none focus:outline-none focus:border-primary/50 custom-scrollbar"
                                />
                            ) : (
                        ...
                        <div>
                            ...
                            {editing ? (
                                <textarea
                                    ...
                                    className="w-full h-24 rounded-lg border border-glass-border bg-elevated px-3 py-2.5 text-[12px] text-foreground leading-relaxed resize-none focus:outline-none focus:border-red-400/30 custom-scrollbar"
                                />
                            ) : (
                                <div className="rounded-lg border border-glass-border bg-glass px-3 py-2.5">
                                    <p className="text-[12px] text-text-secondary leading-relaxed whitespace-pre-wrap">
